...
5. **Shared route-compatibility utility retired**: `saas-ui/domains/shared/lib/routeCompatibility.ts` (and its tests) was removed after middleware/auth call-sites were cut over.
